...
$(document).ready(function(e){
  $("#ayuda").on('click', function(){
    $("#vistas").attr('src','../../ayuda/ayuda.html');
  })
  $("#inicio").on('click', function(){
    $("#vistas").attr('src','../../inicio/inicio.html');
  })
  $("#nosotros").on('click', function(){
    $("#vistas").attr('src','../../nosotros/nosotros.html');
  })
  $("#rutas-crudCrear").on('click', function(){
    $("#vistas").attr('src','../../modulos/rutas-crud/crear.html');
  })
